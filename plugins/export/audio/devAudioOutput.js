...
// happens. Never runs in a packaged build, and is best-effort throughout -
// any failure (device unplugged, API unsupported, enumeration denied)
// silently leaves output on the system default rather than breaking real
// playback. Duplicated from core's own copy (src/renderer/core/
// devAudioOutput.js) and the Remix plugin's own duplicate of it - this
// plugin can't import files outside its own directory either.
